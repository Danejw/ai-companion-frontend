                ...
                <ScrollArea className="h-full w-full">
                    <div className="flex min-h-full w-full justify-center">
                        <div className="w-full max-w-7xl px-4 sm:px-6 lg:px-8">
                            ...
                            <section className="relative text-center py-20 pt-24 mb-12 sm:mb-16 lg:mb-20 overflow-hidden rounded-b-3xl">
                                ...
                                <span className="inline-block px-4 py-1.5 mb-6 text-xs font-semibold tracking-wider text-white uppercase bg-accent/60 rounded-full shadow-sm animate-float">
                                    Introducing Knolia
                                </span>
                                ...
                                <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground mb-10 sm:mb-12 max-w-3xl mx-auto leading-relaxed">
                                    Your personalized AI that learns and adapts to your unique personality. Designed with empathy to combat loneliness and foster genuine understanding in a safe, non-judgmental space.
                                </p>
                                ...
                                <div className="flex justify-center">
                                    <a
                                        ...
                                        className="relative inline-flex items-center justify-center px-8 py-4 text-base font-medium rounded-xl shadow-md text-white bg-accent/70 hover:bg-accent/100 transition-all duration-200 overflow-hidden group"
                                    >
                                        <span className="relative z-10">Start Your Conversation</span>
                                        <span className="absolute inset-2 transition-opacity duration-300"></span>
                                    </a>
                                </div>
                            </section>

                            {/* The Loneliness Crisis Section - More modern card style with distinctive background */}
                            <section className="py-16 sm:py-24 mb-12 sm:mb-16 lg:mb-20 relative rounded-3xl px-4 sm:px-8">
                                <div className="absolute inset-0 -z-10 bg-gradient-to-r from-gray-100/30 to-accent/50 rounded-3xl transform -rotate-1 scale-105"></div>
                                <div className="bg-card/90 border border-border/50 rounded-xl p-8 sm:p-12 text-center shadow-lg backdrop-blur-sm">
                                    {/* Icon with enhanced styling */}
                                    <div className="flex justify-center mb-6">
                                        <div className="relative">
                                            <div className="relative bg-accent/40 p-4 rounded-full">
                                                <Users className="h-12 w-12 text-accent" />
                                            </div>
                                        </div>
                                    </div>
                                    
                                    <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-6 sm:mb-8 text-accent">
                            ...
                            <section className="py-16 sm:py-24 mb-12 sm:mb-16 lg:mb-20 rounded-3xl px-4 sm:px-8">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
                                    ...
                                    <div className="p-6 sm:p-8 border bg-card/60 backdrop-blur-sm rounded-lg shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col transform hover:-translate-y-1 group">
                                        <div className="mb-5 inline-flex items-center justify-center h-14 w-14 rounded-full bg-accent/20 text-accent group-hover:from-primary/30 group-hover:to-accent/30 transition-all duration-300 animate-float">
                                    ...
                                    {/* Feature 2 */}
                                    <div className="p-6 sm:p-8 border bg-card/60 backdrop-blur-sm rounded-lg shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col transform hover:-translate-y-1 group">
                                        <div className="mb-5 inline-flex items-center justify-center h-14 w-14 rounded-full bg-accent/20 text-accent group-hover:from-primary/30 group-hover:to-accent/30 transition-all duration-300 animate-float" style={{ animationDelay: "0.5s" }}>
                                    ...
                                    {/* Feature 3 */}
                                    <div className="p-6 sm:p-8 border bg-card/60 backdrop-blur-sm rounded-lg shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col transform hover:-translate-y-1 group">
                                        <div className="mb-5 inline-flex items-center justify-center h-14 w-14 rounded-full bg-accent/20 text-accent group-hover:from-primary/30 group-hover:to-accent/30 transition-all duration-300 animate-float" style={{ animationDelay: "1s" }}>
                            ...
                            <section className="py-16 sm:py-24 mb-12 sm:mb-16 lg:mb-20 rounded-3xl px-4 sm:px-8 relative">
                                <div className="absolute inset-0 -z-10 bg-gradient-to-r from-accent/50 to-gray-100/30 rounded-3xl transform rotate-1 scale-105"></div>
                                <div className="bg-gradient-to-br from-card/70 to-background/80 backdrop-blur-sm border border-border/40 rounded-xl p-8 sm:p-12 max-w-4xl mx-auto text-center shadow-lg">
                                    <h2 className="text-3xl sm:text-4xl font-bold mb-6 sm:mb-8 text-accent animate-bg-shine">
