...
export default function WelcomePage() {
  return (
    <div className="relative flex flex-col items-center min-h-screen text-foreground">

      <Background/>

      {/* Hero Section */}
      <section className="w-full max-w-6xl mx-auto px-4 sm:px-8 flex flex-col md:flex-row items-center gap-12 text-gray-700">
        <div className="flex flex-col space-y-6 md:w-1/2 animate-in slide-in-from-left duration-700">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-center md:text-left px-4">
          ...
          <div className="pt-4 flex flex-col space-y-2 items-center justify-center md:items-center">
            ...
            <p className="text-sm text-gray-500 text-center px-4 pt-4">
              A conversation away from clarity, comfort, or even just company.
            </p>
          </div>
        </div>
        
        <div className="md:w-1/2 flex mt-12 md:mt-24 justify-center animate-in slide-in-from-right duration-700">
      ...
      <section className="w-full py-16 bg-transparent">
        <div className="max-w-6xl mx-auto px-4 sm:px-8">
          ...
          <p className="text-xl text-center max-w-3xl mx-auto mb-10 px-8 animate-in fade-in duration-1000 delay-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
            <div className="bg-background/80 backdrop-blur-sm p-6 rounded-lg shadow-sm transform transition-all hover:scale-105 hover:shadow-md animate-in fade-in-50 duration-500">
          ...
          <div className="mt-12 flex justify-center animate-in fade-in duration-1000 delay-500">
            <div className="relative w-full max-w-3xl h-auto md:h-64 rounded-lg overflow-hidden">
              <div className="absolute inset-0 flex items-center justify-center">
                <Image 
      ...
      <section className="w-full py-16 bg-gradient-to-b from-background/10 to-accent/20 text-gray-700">
        <div className="max-w-6xl mx-auto px-4 sm:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 border border-black/5 rounded-lg bg-white/80 backdrop-blur-sm transform transition-all hover:scale-105 hover:border-accent/50 hover:shadow-md animate-in fade-in-50 duration-500">
          ...
          <div className="mt-16 w-full flex justify-center animate-in fade-in duration-1000">
            <Carousel
              plugins={[
                Autoplay({
                  delay: 5000,
              ...
              <CarouselContent>
                {quotes.map((item, index) => (
                  <CarouselItem key={index}>
                    <div className="px-6 py-10 bg-white/90 backdrop-blur-sm border border-accent/20 rounded-xl text-center">
                      <p className="text-xl italic leading-relaxed text-gray-700">
                        “{item.quote}”
                      </p>
                      <p className="mt-4 font-medium text-gray-500">by <span className="text-accent font-bold">{item.author}</span></p>
                    </div>
                  </CarouselItem>
                ))}
              </CarouselContent>
              <CarouselPrevious className="hidden md:flex bg-white/50 hover:bg-white/80 backdrop-blur-sm" />
              <CarouselNext className="hidden md:flex bg-white/50 hover:bg-white/80 backdrop-blur-sm" />
            </Carousel>
          </div>
        </div>
      </section>
      ...
      {/* Call to Action */}
      <section className="w-full py-16 bg-gradient-to-b from-accent/20 to-background/10 text-gray-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-8 px-6 text-center animate-in fade-in duration-1000">
          <h2 className="text-3xl font-bold mb-6">When you&apos;re ready, <span className="text-accent">Knolia</span>&apos;s here.</h2>
          
          <div className="space-y-4 mb-8">
            <p className="text-xl">Talk. Vent. Explore. <span className="text-accent font-bold">Heal.</span></p>
            <p className="text-xl">Speak freely. Reflect deeply. <span className="text-accent font-bold">Feel heard.</span></p>
            <p className="text-xl">No performance. No perfect words needed. Just be <span className="text-accent font-bold">you</span>, your way.</p>
          </div>
          
          <Link href="/">
            <Button size="lg" className="rounded-full px-8 py-3 text-lg hover:scale-105 transition-all duration-300 hover:shadow-lg">
